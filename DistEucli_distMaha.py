...
plt.title("Gráfico dist. Euclidiana por Mahalonobis")
plt.xlabel("Mahalonobis")
...
plt.figure(figsize=(8,6))
plt.title("Gráfico dist. Euclidiana por Mahalonobis (matriz covariância = identidade)")
plt.xlabel("Mahalonobis")
plt.ylabel("dist. Euclidiana")
...
plt.figure(figsize=(8,6))
plt.title("Gráfico beta1 por distância Mahalonobis (x,y)")
plt.xlabel("Mahalanobis")
plt.ylabel("Beta1")
...
plt.figure(figsize=(8,6))
plt.title("Gráfico beta0 por distância Mahalonobis (x1,x2)")
plt.plot(distMaha,beta0,marker='o',color='purple')
plt.xlabel("Dist. Mahalonobis")
plt.ylabel("Beta0")
plt.grid(True)
plt.show()

plt.figure(figsize=(8,6))
plt.title("Gráfico beta1 por distância Mahalonobis (x1,x2)")
...
plt.figure(figsize=(8,6))
plt.title("Gráfico beta2 por distância Mahalonobis (x1,x2)")
